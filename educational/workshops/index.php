      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="../../educational/pdf-word/t.pdf" target="_blank">Diplmatura Acompañamiento Terapeutico</a></li>
            <li><a class="dropdown-item" href="./../educational/pdf-word/tbb.pdf" target="_blank">Taller Biodecodifiación Biológica</a></li>
            <li><a class="dropdown-item" href="./../educational/pdf-word/pco.pdf" target="_blank">Diplomatura Coaching Ontologico y Programación Neurolinguistica</a></li>
            <li><a class="dropdown-item" href="./../educational/pdf-word/opsca.pdf" target="_blank">Diplomatura Operador Socio-Comunitario en Adicciones</a></li>
