...
// Obtener inscripciones de la base de datos (solo los campos necesarios)
$sql = "SELECT * FROM formulario_inscripcion";
...
<body>
                    ...
                    <table id="inscriptionsTable" class="table table-striped">
                        ...
                        <tbody>
                            ...
                            if ($result->num_rows > 0) {
                                // Mostrar las inscripciones en la tabla
                                ...
                                echo "<tr><td colspan='4' class='text-center'>No hay inscripciones disponibles.</td></tr>";
                            }
    ...
    <script>
        $(document).ready(function() {
            $('#inscriptionsTable').DataTable(); // Inicializar DataTable
        });
    </script>
</body>
</html>
